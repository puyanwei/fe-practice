...
const FurnitureShop = () => {
  ...
  const greyOutBackgroundStyle =
    'absolute top-0 left-0 z-10 h-full w-full opacity-50 pointer-events-none';
  return (
    <div className="furniture-shop">
      ...
      <div className="relative">
        <span className={`${showNavbar && greyOutBackgroundStyle}`}>
          <Carousel
            mobileImages={[
          ...
          <div className="m-5">
            ...
            <a href="#">
              <span
                className={
                  'inline-block uppercase text-xxs mt-10 ml-0 mb-2 mr-6 tracking-xlg font-semibold no-underline text-black'
                }
              >
                Shop now
              </span>
